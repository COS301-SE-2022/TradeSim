...
function addRule() {
    ...
    if (document.getElementById('r1').selected == true)
    {
        ...
        rule.innerHTML = '<div class="amount-input-row">' +
            '<div class="card2" id="etfbody" style="position: relative; bottom: 110px; right: 12px">' +
            ...
            '<button class="create-btn" id="btn1" style="width: 50px; display: inline-block; position: relative; left: 660px; bottom: 1px;" onclick="ConfirmRule(0)">add</button>' +
            '</div>' +
            '</div>' +
            '</div>' +
            '<b style="color: black; position: relative; bottom: 180px; right: 10px;">' + document.getElementById('r1').textContent + '</b>'
    }
    ...
    if (document.getElementById('r2').selected == true) {
        ...
        rule.innerHTML = '<div class="amount-input-row">' +
            ...
            '</select>' +
            '</div>' +
            '<button class="create-btn" id="btn2" style="width: 50px; display: inline-block; position: relative; left: 730px; top: 3px;" onclick="ConfirmRule(1)">add</button>' +
            '</div>' +
            '</div>' +
            '<b style="color: black; position: relative; bottom: 180px; right: 10px;">' + document.getElementById('r2').textContent + '</b>'
    }
    ...
    if (document.getElementById('r3').selected == true) {
        ...
        rule.innerHTML = '<div class="amount-input-row">' +
            ...
            '</select>' +
            '</div>' +
            '<button class="create-btn" id="btn3" style="width: 50px; display: inline-block; position: relative; left: 730px; top: 3px;" onclick="ConfirmRule(2)">+</button>' +
            '</div>' +
            '</div>' +
            '<b style="color: black; position: relative; bottom: 180px; right: 10px;">' + document.getElementById('r3').textContent + '</b>'
    }
    ...
    if (document.getElementById('r4').selected == true)
    {
        ...
        rule.innerHTML = '<div class="amount-input-row">' +
            ...
            '</select>' +
            '</div>' +
            '<button class="create-btn" id="btn4" style="width: 50px; display: inline-block; position: relative; left: 730px; top: 3px;" onclick="ConfirmRule(3)">+</button>' +
            '</div>' +
            '</div>' +
            '<b style="color: black; position: relative; bottom: 180px; right: 10px;">' + document.getElementById('r4').textContent + '</b>'
    }
    ...
    if (document.getElementById('r6').selected == true) {
        ...
        rule.innerHTML = '<div class="amount-input-row">' +
            ...
            '<button class="create-btn" id="btn6" style="width: 50px; display: inline-block; position: relative; left: 205px; bottom: 1px;" onclick="ConfirmRule(11)">+</button>' +
            '</div>' +
            '</div>' +
            '</div>' +
            '<b style="color: black; position: relative; bottom: 180px; right: 10px;">' + document.getElementById('r6').textContent + '</b>'
    ...
    if (document.getElementById('r7').selected == true) {
        ...
        rule.innerHTML = '<div class="amount-input-row">' +
            ...
            '<button class="create-btn" id="btn7" style="width: 50px; display: inline-block; position: relative; left: 205px; bottom: 1px;" onclick="ConfirmRule(12)">+</button>' +
            '</div>' +
            '</div>' +
            '</div>' +
            '<b style="color: black; position: relative; bottom: 180px; right: 10px;">' + document.getElementById('r7').textContent + '</b>'
    ...
    if (document.getElementById('r8').selected == true) {
        ...
        rule.innerHTML = '<div class="amount-input-row">' +
            ...
            '<button class="create-btn" id="btn8" style="width: 50px; display: inline-block; position: relative; left: 205px; bottom: 1px;" onclick="ConfirmRule(13)">+</button>' +
            '</div>' +
            '</div>' +
            '</div>' +
            '<b style="color: black; position: relative; bottom: 180px; right: 10px;">' + document.getElementById('r8').textContent + '</b>'
    ...
    if (document.getElementById('r10').selected == true) {
        ...
        rule.innerHTML = '<div class="amount-input-row">' +
            ...
            '<button class="create-btn" id="btn10" style="width: 50px; display: inline-block; position: relative; left: 205px; bottom: 1px;" onclick="ConfirmRule(101)">+</button>' +
            '</div>' +
            '</div>' +
            '</div>' +
            '<b style="color: black; position: relative; bottom: 180px; right: 10px;">' + document.getElementById('r10').textContent + '</b>'
    ...
    if (document.getElementById('r11').selected == true) {
        ...
        rule.innerHTML = '<div class="amount-input-row">' +
            ...
            '<button class="create-btn" id="btn11" style="width: 50px; display: inline-block; position: relative; left: 35px; bottom: 1px;" onclick="ConfirmRule(102)">+</button>' +
            '</div>' +
            '</div>' +
            '</div>' +
            '<b style="color: black; position: relative; bottom: 180px; right: 10px;">' + document.getElementById('r11').textContent + '</b>'
    ...
    if (document.getElementById('r12').selected == true) {
        ...
        rule.innerHTML = '<div class="amount-input-row">' +
            ...
            '<button class="create-btn" id="btn12" style="width: 50px; display: inline-block; position: relative; left: 5px; bottom: 1px;" onclick="ConfirmRule(103)">+</button>' +
            '</div>' +
            '</div>' +
            '</div>' +
            '<b style="color: black; position: relative; bottom: 180px; right: 10px;">' + document.getElementById('r12').textContent + '</b>'
    }
    ...
    if (document.getElementById('r13').selected == true) {
        ...
        rule.innerHTML = '<div class="amount-input-row">' +
            ...
            '<button class="create-btn" id="btn13" style="width: 50px; display: inline-block; position: relative; left: 265px; bottom: 1px;" onclick="ConfirmRule(104)">+</button>' +
            '</div>' +
            '</div>' +
            '</div>' +
            '<b style="color: black; position: relative; bottom: 180px; right: 10px;">' + document.getElementById('r13').textContent + '</b>'
    ...
    if (document.getElementById('r14').selected == true) {
        ...
        rule.innerHTML = '<div class="amount-input-row">' +
            ...
            '<button class="create-btn" id="btn14" style="width: 50px; display: inline-block; position: relative; left: 55px; bottom: 1px;" onclick="ConfirmRule(105)">+</button>' +
            '</div>' +
            '</div>' +
            '</div>' +
            '<b style="color: black; position: relative; bottom: 180px; right: 10px;">' + document.getElementById('r14').textContent + '</b>'
    }
    ...
    if (document.getElementById('r15').selected == true) {
        ...
        rule.innerHTML = '<div class="amount-input-row">' +
            ...
            '<button class="create-btn" id="btn15" style="width: 50px; display: inline-block; position: relative; left: 255px; bottom: 1px;" onclick="ConfirmRule(106)">+</button>' +
            '</div>' +
            '</div>' +
            '</div>' +
            '<b style="color: black; position: relative; bottom: 180px; right: 10px;">' + document.getElementById('r15').textContent + '</b>'
    }
    ...
    if (document.getElementById('r16').selected == true) {
        ...
        rule.innerHTML = '<div class="amount-input-row">' +
            ...
            '<button class="create-btn" id="btn16" style="width: 50px; display: inline-block; position: relative; left: 550px; bottom: 1px;" onclick="ConfirmRule(200)">+</button>' +
            '</div>' +
            '</div>' +
            '</div>' +
            '<b style="color: black; position: relative; bottom: 180px; right: 10px;">' + document.getElementById('r16').textContent + '</b>'
    }
    ...
    if (document.getElementById('r17').selected == true) {
        ...
        rule.innerHTML = '<div class="amount-input-row">' +
            ...
            '<button class="create-btn" id="btn17" style="width: 50px; display: inline-block; position: relative; left: 550px; bottom: 1px;" onclick="ConfirmRule("201")">+</button>' +
            '</div>' +
            '</div>' +
            '</div>' +
            '<b style="color: black; position: relative; bottom: 180px; right: 10px;">' + document.getElementById('r17').textContent + '</b>'
    }
    ...
    if (document.getElementById('r18').selected == true) {
        ...
        rule.innerHTML = '<div class="amount-input-row">' +
            ...
            '<button class="create-btn" id="btn18" style="width: 50px; display: inline-block; position: relative; left: 550px; bottom: 1px;" onclick="ConfirmRule("202")">+</button>' +
            '</div>' +
            '</div>' +
            '</div>' +
         ...
         else
         {
             ...
             for(var i = 0; i < numofetfs; i++)
             {
                 document.getElementById("options").innerHTML +=
                     "<option value=" + '"' + jd.Data[i].ETFID + '"' + ">" + jd.Data[i].ETFName + "</option>"
             }
...
function confirm()
{
        ...
        "<div class=\"amount-input-row\">\n" +
            '<div class="card2" id="etfbody" style=" position: relative; bottom: 70px; right: 12px">' +
                ...
                '<div class="custom-select" style="display: inline-block; position: relative; top:5px; left:40px;">' +
                    ...
                    '<button class="create-btn" id="btn1" style="width: 50px; display: inline-block; position: relative; left: 6px; bottom: 1px;" onclick="editamount()">edit</button>' +
                    '<button class="create-btn" id="btn1" style="width: 70px; display: inline-block; position: relative; left: 400px; bottom: 1px;" onclick="clearRules()">clear</button>' +
    ...
    document.getElementById("ruleadder").innerHTML =
        "<div class=\"amount-input-row\">\n" +
        "                <div class=\"card2\" id=\"etfbody\" style=\" position: relative; bottom: 95px; right: 12px\">\n" +
        ...
        "                          <option disabled hidden value=\"16\" id=\"r16\">200: Set a balance period</option>\n" +
        "                          <option disabled hidden value=\"17\" id=\"r17\">201: The system must allow the user to define a percentage that a stock can drop before the ETF sells the stock automatically</option>\n" +
        "                          <option disabled hidden value=\"18\" id=\"r18\">202: The system must allow the user to set a time period in which it must reconsider its stocks</option>\n" +
        "\n" +
        "                        </select>\n" +
        "                    </div>\n" +
        "\n" +
        ...
        "\n" +
        "                        <button class=\"create-btn\" onclick=\"addRule()\" style=\"width: 120px; display: inline-block; position: relative; left: 952px; bottom: 22px;\">Add Rule</button>\n" +
        "                    </div>\n" +
        "\n" +
        "\n" +
        "                </div>\n" +
...
function editamount()
{
    ...
    var eID = document.getElementById("options").value;
    var newAmount = document.getElementById("inputamount").value;
