...
function addRule() {
    ...
    if (document.getElementById('r1').selected == true) {
        ...
        rule.innerHTML =
            ...
            '<button class="create-btn" id="btn1"  onclick="ConfirmRule(0)">add</button>' + //style="width: 50px; display: inline-block; position: relative; left: 660px; bottom: 1px;"
            '</div>' +
            '</div>' +
            '</div>'
    }
    ...
    if (document.getElementById('r2').selected == true) {
        ...
        rule.innerHTML = '<b>' + document.getElementById('r2').textContent + '</b>' + // style="color: black; position: relative; bottom: 180px; right: 10px;"
            ...
            '</select>' +
            '</div>' +
            '<button class="create-btn" id="btn2" onclick="ConfirmRule(1)">add</button>' + // style="width: 50px; display: inline-block; position: relative; left: 730px; top: 3px;"
            '</div>' +
            '</div>'
    }
...
function confirm() {
    ...
    document.getElementById("ruleadder").innerHTML =
        ...
        "\n" +
        "                        <button class=\"create-btn\" onclick=\"addRule()\" >Add Rule</button>\n" +
        "                    </div>\n" +
        "\n" +
        "\n" +
        "                </div>\n" +
...
function editname() {
    ...
    document.getElementByID("inputname").innerHTML += jd.ETFID + '"' + ">" + jd.ETFName;
