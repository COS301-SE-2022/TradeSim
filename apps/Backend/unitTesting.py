...
class TestStrings(unittest.TestCase):
    ...
    def test_stockInformationUnitTest_returnValueNone(self,mock_get):
        ...
        response = info.stockInformation("L",fileLocation)
        ...
        fileLocation = 'apps/Backend/databases/industries.csv'
        response = info.stockInformation("AAPL",fileLocation)
    ...
    def test_AiFactor_code000Value(self,mock_get):
        ...
        mock_seedValue = 81
        fileLocation = 'apps/Backend/databases/industries.csv'
        aiTing = AiFactor.AiFactor(mock_Date,mock_seedValue,fileLocation)
        mockResponse = Response()
